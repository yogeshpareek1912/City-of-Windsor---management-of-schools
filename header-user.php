...
<head>
	...
	<title>SCHOOL ADMIN| <?php echo (isset($x->TableTitle) ? $x->TableTitle : ''); ?></title>
...
<div class="wrapper">
    ...
    <div class="sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <li>
                    <a href="student_performance_view.php">
                        <i class="ti-user"></i>
                        <p>Student performance</p>
                    </a>
                </li>
                <li>
                    <a href="staff_performance_view.php">
                        <i class="fa fa-users" aria-hidden="true"></i>
                        <p>Staff performance</p>
                    </a>
                </li>
                <li>
                    <a href="school_performance_view.php">
                        <i class="ti-user"></i>
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">City of Windsor Management Of Schools</a>
                </div>
