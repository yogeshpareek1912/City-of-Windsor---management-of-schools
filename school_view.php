...
<div class="container">
  <a href="add.php"  class="btn btn-primary">Add New School</a>  <a href="index.php" class="btn btn-primary">Go to Home</a><br/><br/>

    <table width='80%' border=1>

    <tr>
        <th>Name</th> <th>Address</th> <th>Code</th> <th>Update</th>
    </tr>
    <?php
